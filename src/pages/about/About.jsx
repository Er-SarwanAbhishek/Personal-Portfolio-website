        ...
        <div class="aboutContents">
          ...
          <div class="aboutInfo">
            ...
            <p>
              ...
              websites using MERN stack and Django framework. I have
              successfully created an E-commerce website using Django and
              SQLite. Currently I am working on creating a room booking web
              application.{" "}
            </p>
            <div class="aboutPersonalInfo">
              ...
              <div>
                <span>Phone No:</span>
                <span>8057802352</span>
              </div>
              <div>
                <span>Address:</span>
                <span>
                  Aurangjebpur Hardas Tehsil-Nagina, Dist-Bijnor (U.P) Pin code-
                  246762
                </span>
              </div>
            </div>
          ...
          <div class="resumeEvenColumn">
            ...
            <div class="resumeContents">
              ...
              <div class="box">
                ...
                <p>
                  R V Institute Of Technology, Bijnor (AKTU University,Lucknow)
                </p>
                <h4>Aggregate - 81.17%</h4>
              </div>
            </div>
