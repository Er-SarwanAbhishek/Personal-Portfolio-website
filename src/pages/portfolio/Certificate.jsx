...
import {deleteInterval} from 'react'
...
const Certificate = () => {
  ...
  function popupFunction() {
    document.querySelector('.portfolioPopupBox').style.display = 'block';
    document.querySelector('.portfolioPopupBox img').src = this.querySelector('.imgBox img').getAttribute('src');
  }

  // When you click the cancel button, then hide the popup box
  document.querySelector('.portfolioPopupBox span').addEventListener('click', function () {
  ...
  <div>
    <section class="reviewSection">
      ...
      <header class="reviewTitle">
        <h1>Testimonials</h1>
      </header>
     
      <main class="reviewContents">
        ...
        <div class="reviewCardsIndicators">
          <div class="dot active" data-number="0"></div>
